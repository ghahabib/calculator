...
!(function (t) {
  ...
  define("font-loader/main", [], function () {
    return (function (t, e) {
      return {
        load: function (n) {
          var i = t();
    ...
    })(jQuery.Deferred, WebFont);
  }),
  define("font-loader", ["font-loader/main"], function (t) {
    return t;
  }),
  define("js/fonts", ["font-loader"], function (t) {
    return {
      load: function (e) {
        return (
          (e = e || [
    ...
    elementQuery(
      {
        ...
        ".cta": {
          "min-width": ["731px", "531px"],
          "max-width": ["730px", "530px"],
        },
      },
      !0
    ),
      (function (e) {
        !(function (t) {
          ...
          "(min-width: 53.4375em)": {
            blockVerticalAlign: ["#footer > div:first-of-type ul"],
          },
        }),
          e.when(t.load()).done(function () {
